					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="table-responsive">
								<form action="Admin_update_detail_image.do" method="post" enctype="multipart/form-data">
									...
									<table class="table table-bordered" id="dataTable" width="100%"
										...
										<tbody>
											...
											<tr>
												<td colspan="5" style="width: 100%"><a><img src="images/<%=img_list.get(seq_img).getImgUrl()%>"></a></td>
											</tr>
											<tr>
									...
									<div style="text-align: center">
										<input class="btn btn-primary" type="submit" style="width: 250px;" value="수정">
									</div>
								</form>
							</div>
						</div>
