    ...
    <body>
        ...
        <form>
          ...
          <div class="form-section">
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="u_id" name="u_id" value="${mvo.memberId }" readonly />
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            <div class="row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control mb-2" id="u_name" name="u_name" value="${mvo.memberName }"
                  readonly />
          ...
          <div class="form-section">
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <div class="d-grid gap-3">
                  <input type="text" class="form-control" id="u_nick" name="u_nick" value="${mvo.memberNick }"
                    readonly />
                </div>
              </div>
            </div>
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="new_u_nick" name="new_u_nick"
                  placeholder="변경할 닉네임을 입력하세요" />
              </div>
              <div class="col-sm-2">
                <button type="button" id="modifyNickBtn" name="modifyNickBtn" class="btn btn btn-secondary">닉네임
                  수정</button>
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="tel" class="form-control" id="u_phone" name="u_phone" value="${mvo.memberPhone }" />
              </div>
            </div>
            ...
            <div class="mb-3 row">
              <label for="new_u_phone" class="col-sm-2 col-form-label">변경
                연락처</label>
              <div class="col-sm-8">
                <input type="tel" class="form-control" id="new_u_phone" name="new_u_phone"
                  placeholder="변경할 연락처를 입력하세요" />
              </div>

              <div class="col-sm-2">
                <button type="button" id="ModifyPhoneBtn" name="ModifyPhoneBtn" class="btn btn-secondary">연락처
                  수정</button>
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <div class="d-grid gap-3">
                  <input type="text" class="form-control mb-2" id="u_address" name="u_address"
                    value="${mvo.memberAddress }" readonly />
                </div>
              </div>
            </div>
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control mb-2" id="new_u_address" name="new_u_address"
                  placeholder="변경할 주소를 입력하세요" />
              </div>
              <div class="col-sm-2">

                <button type="button" id="modifyAddress" name="modifyAddress" class="btn btn-secondary">배송지 수정</button>
          ...
          <div class="form-section">
            <div class="mb-3">
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="marketing-consent" checked /> <label
                  class="form-check-label" for="marketing-consent"> 마케팅 목적의
                  개인정보 수집 및 이용 동의함 </label> <a href="#" class="text-muted">전문보기 ></a>
              </div>
              <div class="form-check mt-2">
                <input class="form-check-input" type="checkbox" id="ads-consent" checked /> <label
                  class="form-check-label" for="ads-consent">
          ...
          <div class="d-flex justify-content-end mb-3">
            <button type="button" class="btn btn-outline-secondary me-2">
              탈퇴하기</button>
            <button type="button" id="exitBtn" name="exitBtn" class="btn btn-primary" >나가기</button>
          </div>
        </form>
      </div>
      ...
      <script>
          ...
          fetch('modifyNick.do?id=' + uId + '&nick=' + nick)
            ...
            .then(result => {
              ...
              if (result.retCode == 'OK') {
                ...
                //새닉네임 초기화
                document.querySelector("#new_u_nick").value = "";
                //기존닉네임에 새닉네임 넣어주는 것
             	
                //console.log(nick);
                //document.querySelector("#u_id").value = nick;
                location.reload();
        ...
        document.querySelector("#exitBtn").addEventListener('click', function () {
        	console.log('exitBtn작동');
       		location.href = 'myOrderList.do?buyerId=${id}';
          //window.location.replace('myOrderList.do?buyerId=${id}');
        });
